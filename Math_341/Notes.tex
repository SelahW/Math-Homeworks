...
\begin{proof} Moving everything to one side:$$n^2-2n-1>0:n\geq3$$Completing the square:$$(n-1)^2-2>0:n\geq3$$Getting n alone:$$(n-1)^2>2:n\geq3$$The absolute smallest that $(n-1)^2$ can be is 4, when $n=3$, which is greater than 2. Therefore, $(n-1)^2>2:n\geq3$, and similarly: $$2n+1<n^2:n\geq3$$ \end{proof}
\newpage
