...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Transition matrix: \newline\includegraphics[scale=.35]{Matrix3.png}
    \item Running this code gave the following results:\newline\includegraphics[scale=.5]{Code.png}\begin{itemize}
